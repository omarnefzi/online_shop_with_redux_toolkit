...
const handleadded=()=>{
  ...
  toast.success(`the ${products.title} added successfully`)
}
  return (
    <>
...
<div style={{backgroundColor: 'rgba(0, 0, 0, 0)'}}>
  <div className="container px-5 py-24 mx-auto" style={{cursor: 'auto'}}>
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt=  {products.title} className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src=  {products.image} style={{cursor: 'auto'}} />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" style={{cursor: 'auto'}}>
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1" style={{cursor: 'auto'}}>  {products.title}</h1>
        ...
        <div className="flex">
          ...
          <button onClick={handleadded} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add To Card</button>
